...
public class VistaSegonaControllerGrup implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb) {
    	...
    	columnaPrimerAL.setCellValueFactory(param -> new ReadOnlyObjectWrapper <>((param.getValue()).getAlumne2()));
    	...
    	taula.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
    		...
    		System.out.println("PERO AIXO PASSA PER AQUI O NO HOSTIA PUTA");
